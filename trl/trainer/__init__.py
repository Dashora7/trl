...
_import_structure = {
    ...
    "grpo_trainer_vectorized": ["GRPOTrainerVectorized"],
    ...
    "rloo_trainer_async": ["RLOOTrainerAsync"],
...
if TYPE_CHECKING:
    ...
    from .grpo_trainer_vectorized import GRPOTrainerVectorized
    ...
    from .rloo_trainer_async import RLOOTrainerAsync
